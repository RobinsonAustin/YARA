...
def easyMode():
  ...
  print ("The bot chose: %s" % machineChoice)
  ...
  while(continuePlaying):
    ...
    if (choice == 5):
      ...
      print ("The machine chose %s" % choices[machineChoice])
      print ("You %s" % result)
      print ("The bot chose Rock %s" % n1)
      print ("The bot chose Paper %s" % n2)
      print ("The bot chose Scissors %s" % n3)

      # if(result == "Win!"):
      #     win = result
      #     assert(win == "Win!")
      #     print("If this executes you indeed did %s" % win)
      # elif(result == "Tied!"):
      #     tied = result
      #     assert(tied == "Tied!")
      #     print("If this executes you indeed did %s" % tied)
      # elif(result == "Lose!"):
      #     lose = result
      #     assert(lose == "Lose!")
      #     print("If this executes you indeed did %s" % lose)
