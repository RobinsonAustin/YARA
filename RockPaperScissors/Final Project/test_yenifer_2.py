	...
	for x in range (99):
		...
		if (choice == 5):
			...
			if (streak > 3):
				...
				print("Yo. Stop cheating and keep your eyes off my code. Just play normally. You wouldn't be able to look at previous decisions so accurately in a real game alright? If ya continue to do dis the machine won't care anymore - it's a sore loser and hates people like you.")
				machineChoice = random.randint(0, 2)
...
def test_intermediate_scissors():
# def main():
  playAgain = True
  notyesorno = True
...
# test_intermediate_rock()
# test_intermediate_paper()
# test_easy_rock()


class TestModes(unittest.TestCase):

    def test_easy_rock(self):
        test_easy_rock()
        self.assertTrue(winEas > winInt)

    def test_easy_paper(self):
        test_easy_paper()
        self.assertTrue(winEas > winInt)
    #
    def test_easy_scissors(self):
        test_easy_scissors()
        self.assertTrue(winEas > winInt)

    def test_intermediate_rock(self):
        test_intermediate_rock()
        self.assertTrue(winEas > winInt)

    def test_intermediate_paper(self):
        test_intermediate_paper()
        self.assertTrue(winEas > winInt)

    def test_intermediate_scissors(self):
        test_intermediate_scissors()
        self.assertTrue(winEas > winInt)
