...
def fight(rounds):
    ...
    for i in range(0,rounds):
        ...
        if (results == "Win!"):
            ...
            bot2score[2] += 1
            bot1score[2] += 1
    bot1win = float(bot1score[0]);
    bot1win = (bot1win/100000)*100;
    bot2win = float(bot2score[0]);
    bot2win = (bot2win/100000)*100;
    print ("Bot1 won %s times, lost %s times, and tied %s times.\nBot1 won %.2f percent of the games\n\nTo check:\n\nBot2 won %s times, lost %s times, and tied %s times.\nBot2 won %.2f percent of the games." % (bot1score[0],bot1score[1],bot1score[2],bot1win,bot2score[0],bot2score[1],bot2score[2],bot2win))
